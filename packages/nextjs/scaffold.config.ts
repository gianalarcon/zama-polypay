...
// Polypay-Zama: Sepolia is the only target network. The original Polypay
// scaffold targeted Horizen Testnet + Base Sepolia; both are dropped here
// because the Zama FHE coprocessor + KMS only support Sepolia today.
